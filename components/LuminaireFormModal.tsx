...
export function LuminaireFormModal({ isOpen, onClose, onSubmit, defaultValues }: LuminaireFormModalProps) {
  ...
  // Mettre à jour le formulaire quand defaultValues change
  useEffect(() => {
    if (defaultValues) {
      setFormData((prev) => ({
        ...prev,
        designer: defaultValues.designer || prev.designer,
        periode: defaultValues.periode || prev.periode,
        collaboration: defaultValues.collaboration || prev.collaboration,
      }))
    }
  }, [defaultValues])
