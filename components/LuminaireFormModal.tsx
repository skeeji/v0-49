...
export function LuminaireFormModal({ isOpen, onClose, onSubmit, defaultValues, onSuccess }: LuminaireFormModalProps) {
  ...
  // Mettre à jour le formulaire quand defaultValues change ou quand le modal s'ouvre
  useEffect(() => {
    if (isOpen && defaultValues) {
      console.log("📝 Application des valeurs par défaut:", defaultValues)
      setFormData((prev) => ({
        ...prev,
        designer: defaultValues.designer || "",
        periode: defaultValues.periode || "",
        collaboration: defaultValues.collaboration || "",
      }))
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let designerImageFilename = defaultValues?.designerImageFilename || ""
      if (designerImage) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor="designer">Designer / Artiste</Label>
              <Input
                id="designer"
          ...
          <div>
            ...
            {defaultValues?.designerImageFilename && !designerImage && (
              <p className="text-sm text-gray-600 mb-2">
                Image existante : {defaultValues.designerImageFilename} (téléchargez une nouvelle image pour la
                remplacer)
              </p>
            )}
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
