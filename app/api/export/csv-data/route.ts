  ...
  try {
    ...
    const dataForCsv = luminaires.map(luminaire => {
      ...
      return {
        ...
        "Image luminaire": luminaire.filename || (Array.isArray(luminaire.images) && luminaire.images.length > 0 ? luminaire.images[0] : "") || luminaire["Nom du fichier"] || "",
        "Image designer": luminaire.designerImageFilename || luminaire["Image Designer"] || "",
      };
    });
