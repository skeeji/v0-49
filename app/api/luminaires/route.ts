...
    console.log(`📊 ${luminaires.length} luminaires récupérés pour la page ${page}`)
    ...
    const formattedLuminaires = luminaires.map((luminaire) => ({
        ...
        // --- MODIFICATIONS POUR LA RÉTRO-COMPATIBILITÉ ---
        ...
        materiaux: luminaire.materiaux || [], // Doit retourner un tableau
        // --- FIN DES MODIFICATIONS ---

        // Champs dupliqués pour compatibilité existante
        ...
        // Champs CSV originaux (pour référence)
