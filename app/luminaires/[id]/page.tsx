...
export default function LuminaireDetailPage() {
  ...
  useEffect(() => {
    ...
    async function fetchLuminaireData() {
      ...
      try {
        ...
        if (result.success) {
          // MODIFICATION 2: Formater le luminaire avec tous les champs COMPLÈTEMENT séparés
          const formattedLuminaire = {
            ...
            // MODIFICATION 2: Champs COMPLÈTEMENT séparés - AUCUN lien entre eux
  ...
  const handleUpdate = async (field: string, value: string) => {
    ...
    const keyMapping: { [key: string]: string } = {
      artist: "designer",
      specialty: "periode",
      collaboration: "collaboration", // MODIFICATION 2: collaboration reste collaboration - AUCUN lien avec description
      description: "description", // MODIFICATION 2: description reste description - AUCUN lien avec collaboration
      name: "nom",
      year: "annee",
      signed: "signe",
            ...
            <div className="h-full overflow-y-auto p-6">
              <div className="space-y-6 font-serif">
                ...
                <div className="space-y-4">
                  {/* MODIFICATION 2: Champs COMPLÈTEMENT séparés avec leurs vraies valeurs distinctes */}
                  <div>
                  ...
                  {/* MODIFICATION 2: Collaboration et Description sont COMPLÈTEMENT SÉPARÉS - AUCUN lien */}
                  <div>
