  ...
  if (!designer) {
    return (
      <div className="container-responsive py-8 text-center">
        <p className="text-lg">Désolé, ce designer n'a pas été trouvé.</p>
        <Link href="/designers">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-lg text-gray-600 mb-6">
                {designerLuminaires.length} luminaire{designerLuminaires.length > 1 ? "s" : ""} trouvé
                {designerLuminaires.length > 1 ? "s" : ""}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-8 shadow-lg">
          ...
          {designerLuminaires.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p>Aucun luminaire n'est actuellement associé à ce designer.</p>
            </div>
          )}
        </div>
      </div>
