...
                    <Image src={designer.image ? `${backendUrl}${designer.image}` : "/placeholder.svg"} alt={designer.name} fill className="object-cover rounded-full" />
                  </div>
...
                        <Image src={luminaire.image ? `${backendUrl}${luminaire.image}` : "/placeholder.svg?height=80&width=80"} alt={""} fill className="object-cover" />
                      </div>
                    ))}
                  </div>
