...
export default function ImportPage() {
  ...
  // ====================================================================
  // === DÉBUT DE LA CORRECTION : `handleCsvUpload` REMPLACÉE ===
  // ====================================================================
  const handleCsvUpload = async (data: any[]) => {
    ...
    try {
        const processedData = data.map((item) => {
            ...
            // Nettoyage du nom du designer DÈS L'IMPORT
            const cleanDesignerName = (item["Artiste / Dates"] || "").split(':')[0].trim();

            return {
                nom: finalNom,
                designer: cleanDesignerName, // On utilise le nom nettoyé
  ...
  // ====================================================================
  // === FIN DE LA CORRECTION `handleCsvUpload` ===
  // ====================================================================
  ...
  // ====================================================================
  // === FIN DE LA CORRECTION `handleDesignersUpload` ===
  // ====================================================================
