      ...
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Carte Gratuit */}
            <Card className="relative bg-white shadow-lg rounded-2xl border-2 border-gray-200">
            ...
            {/* Carte Premium */}
            <Card className="relative bg-white shadow-xl rounded-2xl border-2 border-[#f2d895]">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <span className="bg-[#f2d895] text-gray-900 px-4 py-1 rounded-full text-sm font-medium">
                  Recommandé
                </span>
              </div>
              <CardHeader className="text-center pb-8">
              ...
              <CardContent className="space-y-4">
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  <DialogTrigger asChild>
                    <Button
                      className="w-full text-gray-900 hover:opacity-90 transition-opacity"
                  ...
                  <DialogContent className="sm:max-w-[425px] bg-white">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Remplissez ce formulaire pour demander un abonnement Premium
                      </DialogDescription>
                    </DialogHeader>
